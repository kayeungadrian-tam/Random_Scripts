...
class FooterCanvas(canvas.Canvas):
    def __init__(self, *args, **kwargs):
        ...
        self.pages = []
        canvas.Canvas.setFont(self, "GenShinGothic", font_size)
...
class PDFPSReporte:
    def __init__(self, path):
        ...
        self.firstPage(img_path="test.png")
    ...
    def firstPage(self, img_path):
        img = Image("demo.png", kind="proportional")
    ...
    def summaryTableMaker(self):
        ...
        lineData = [
            ["Total de horas contratadas", "120:00"],
...
def make_graph(file_name: str) -> None:
...
if __name__ == "__main__":
    ...
    report = PDFPSReporte("testests.pdf")
