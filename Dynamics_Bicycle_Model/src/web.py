...
app.layout = html.Div(children=[
        ...
        html.Div([
            ...
            html.Div([
                html.P('This simple simulation aims to demonstrate the movement using the Dynamics Bicycle Model.'),
        ...
        dcc.Graph(id = 'live-graph', animate = False, style={'display': 'inline-block'}), 
        dcc.Interval( 
            id = 'graph-update', 
            interval = 500, 
            n_intervals = 0
...
if __name__ == '__main__': 
    ...
    def update_graph_scatter(n):
        ...
        fig.update_layout(height=450,width=600, showlegend=False, template=template)
