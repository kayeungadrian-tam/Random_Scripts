...
#         self.comboBox.setGeometry(QtCore.QRect(90, 200, 76, 22))
#         self.comboBox.setObjectName("comboBox")
#         self.comboBox.addItem("")
#         self.comboBox.addItem("")
#         self.scrollArea = QtWidgets.QScrollArea(Dialog)
#         self.scrollArea.setGeometry(QtCore.QRect(330, 70, 61, 121))
#         self.scrollArea.setWidgetResizable(True)
#         self.scrollArea.setObjectName("scrollArea")
#         self.scrollAreaWidgetContents = QtWidgets.QWidget()
#         self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 59, 119))
#         self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
#         self.verticalScrollBar = QtWidgets.QScrollBar(self.scrollAreaWidgetContents)
#         self.verticalScrollBar.setGeometry(QtCore.QRect(40, 10, 20, 101))
#         self.verticalScrollBar.setOrientation(QtCore.Qt.Vertical)
#         self.verticalScrollBar.setObjectName("verticalScrollBar")
#         self.scrollArea.setWidget(self.scrollAreaWidgetContents)
#         self.dial = QtWidgets.QDial(Dialog)
#         self.dial.setGeometry(QtCore.QRect(130, 220, 50, 64))
...
#         self.graphicsView.setGeometry(QtCore.QRect(70, 50, 191, 141))
#         self.graphicsView.setObjectName("graphicsView")

        

#         self.retranslateUi(Dialog)
#         self.buttonBox.accepted.connect(self.func)
...
#         self.comboBox.setItemText(0, _translate("Dialog", "test"))
#         self.comboBox.setItemText(1, _translate("Dialog", "test2"))
